...
#define LUNAR_BEHAVIOR_STAGE_READY 0

#define LUNAR_BEHAVIOR_STAGE_UPDATE 1

#define LUNAR_BEHAVIOR_STAGE_PHYSICS 2

#define LUNAR_BEHAVIOR_STAGE_DESTROY 3

// exported-field kind tags for [`LunarFieldValue`] and [`LunarFieldSchema`].
#define LUNAR_FIELD_KIND_FLOAT 0

#define LUNAR_FIELD_KIND_INT 1

#define LUNAR_FIELD_KIND_BOOL 2

#define LUNAR_FIELD_KIND_VEC3 3

#define LUNAR_FIELD_KIND_COLOR 4

#define LUNAR_FIELD_KIND_TEXT 5
