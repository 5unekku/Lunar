...
//!
//! ```ignore
//! use engine_ui::{UiPanel, UiLabel, UiProgressBar, UiButton, UiPlugin};
...
/// screen-space clickable button. draws at [`engine_render::layers::UI`].
///
...
impl GamePlugin for UiPlugin {
    ...
    fn build(&mut self, app: &mut App) {
        ...
        app.add_system_to_stage(engine_core::UpdateStage::Update, ui_interaction_system);
        app.add_system_to_stage(engine_core::UpdateStage::Render, render_ui);
        app.add_system_to_stage(engine_core::UpdateStage::Render, render_progress_bars);
        app.add_system_to_stage(engine_core::UpdateStage::Render, render_buttons);
    }
}
