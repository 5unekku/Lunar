...
//!
//! attach [`ParticleEmitter`] to any entity to emit particles. add [`ParticlePlugin`]
//! to register the simulation — spawn, tick, and render happen automatically.
//!
//! # example
//!
//! ```ignore
...
pub fn draw_particles(pool: Res<ParticlePool>, mut queue: ResMut<RenderQueue>) {
...
/// common, game-facing particle types for `use lunar::prelude::*`.
pub mod prelude {
	pub use crate::{ParticleEmitter, ParticlePlugin};
}
