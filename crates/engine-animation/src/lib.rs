...
//!
//! drives the [`engine_render::Sprite`] component's `source_rect` from a named
//! clip + frame sequence. no skeletal animation — that is post-v1.
//!
//! # usage
//!
//! ```ignore
//! use engine_animation::{AnimationClip, AnimationFrame, Animator, AnimationPlugin};
//!
...
///
/// add this alongside [`engine_render::RenderPlugin`]. the `advance_animations`
