...
///
/// attach alongside [`UiButton`] to opt into mouse hit-testing. updated automatically each frame.
...
/// common, game-facing UI types for `use lunar::prelude::*`.
pub mod prelude {
	pub use crate::{
		ButtonPressedEvent, Interaction, UiButton, UiImage, UiLabel, UiPanel, UiPlugin,
		UiProgressBar,
	};
}
