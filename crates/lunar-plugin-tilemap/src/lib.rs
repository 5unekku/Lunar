...
//!
//! ```ignore
//! use lunar_tilemap::{TileAtlas, TileMap, TileMapPlugin};
//!
...
/// component that holds a 2d grid of tile ids and renders them automatically each frame.
///
...
impl GamePlugin for TileMapPlugin {
	...
	fn build(&mut self, app: &mut App) {
		app.add_system_to_stage(lunar_core::UpdateStage::Render, render_tilemaps);
	}
}
...
/// common, game-facing tilemap types for `use lunar::prelude::*`.
pub mod prelude {
	pub use crate::{TileAtlas, TileMap, TileMapPlugin};
}
