...
//! sprite animation, and the [`CollisionWorld`] resource.
...
pub use collision::{
	Collider, Collider2dBundle, ColliderShape, CollisionWorld, RayHit2d, ray_cast_2d,
};
...
pub fn propagate_transforms(world: &mut World) {
	...
	scratch
		.world_transforms
		.resize(n, WorldTransform::default());
