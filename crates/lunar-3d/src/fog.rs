...
///
/// insert as a resource to enable fog in the render backend. the backend reads
/// this each frame and applies it in the fragment shader using camera-space depth.
/// without this resource, no fog is applied.
///
/// # example
///
/// ```ignore
