...
use crate::visibility::{
    CullSoa, Frustum, ViewportAspect, build_cull_soa, update_frustum,
};
...
/// 2. `propagate_transforms_3d` — propagate local → world transforms AND Visibility → ComputedVisibility in one pass
